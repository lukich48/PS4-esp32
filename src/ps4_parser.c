...
ps4_analog_stick_t parsePacketAnalogStick(uint8_t* packet) {
  ...
  ps4AnalogStick.lx = packet[packet_index_analog_stick_lx];
  ps4AnalogStick.ly = packet[packet_index_analog_stick_ly];
  ps4AnalogStick.rx = packet[packet_index_analog_stick_rx];
  ps4AnalogStick.ry = packet[packet_index_analog_stick_ry];
